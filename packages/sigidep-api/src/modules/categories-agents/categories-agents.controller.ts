...
export class CategoriesAgentsController {
  ...
  @Get('/')
  @UseGuards(new PermissionsGuard(['categories-agents.read']))
  public async filter() {
    return this.services.filter();
  }

  @Post('/')
  @UseGuards(new PermissionsGuard(['categories-agents.create']))
  public async create(
  ...
  @Put('/')
  @UseGuards(new PermissionsGuard(['categories-agents.update']))
  public async update(
    @Body(ValidationPipe) payload: CreateCategorieAgentsDTO,
    @GetCurrentUser() user: UserEntity,
  ) {
