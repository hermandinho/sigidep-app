...
@Component({
  selector: 'app-frais-de-releve',
  templateUrl: './frais-de-releve.component.html',
  styleUrls: ['./frais-de-releve.component.scss'],
  providers: [MessageService],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FraisDeReleveComponent   extends BaseComponent
...
ngOnInit(): void {
  localStorage.setItem('procedure', JSON.stringify('1123'));
  this.primengConfig.ripple = true;
  // code procedure  prime 1123
