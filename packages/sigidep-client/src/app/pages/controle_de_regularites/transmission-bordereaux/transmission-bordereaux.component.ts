...
import { GetTransmissionsReceptions, CreateTransmissionsReception } from '../../../store/actions/transmissions-receptions.actions';
...
export class TransmissionBordereauxComponent extends BaseComponent
implements OnInit {
public busy = false;
...
ngOnInit(): void {
  ...
  this._store.dispatch(
    SetAppBreadcrumb({
      breadcrumb: [
        {
          label: 'breadcrumb.transmissionBordereaux',
        },
      ],
    })
  );
